import { defineConfig, presetAttributify, presetIcons, presetTypography, presetWind3, toEscapedSelector, transformerDirectives, transformerVariantGroup } from 'unocss'
...
export default defineConfig({
  shortcuts: {
    ...
    'fixed-flex-center': 'fixed flex-center left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2',
